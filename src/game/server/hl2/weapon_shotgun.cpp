...
public:
	...
	virtual const Vector& GetBulletSpread( void )
	{
		...
		static Vector cone = VECTOR_CONE_10DEGREES * 36;
...
void CWeaponShotgun::PrimaryAttack( void )
{
	...
	pPlayer->VelocityPunch(pPlayer->EyeDirection3D() * -2000);
	...
	pPlayer->FireBullets( sk_plr_num_shotgun_pellets.GetInt() * 360, vecSrc, vecAiming, GetBulletSpread(), MAX_TRACE_LENGTH, m_iPrimaryAmmoType, 0, -1, -1, 0, NULL, true, true );
	
	pPlayer->ViewPunch( QAngle( random->RandomFloat( -360, 360 ), random->RandomFloat( -360, 360 ), 0 ) );
...
void CWeaponShotgun::SecondaryAttack( void )
{
	...
	pPlayer->VelocityPunch(pPlayer->EyeDirection3D() * -4000);
